...
public class TaxGroupNotEmptyException extends RuntimeException {
   ...
   */
  public TaxGroupNotEmptyException(final String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public TaxGroupNotEmptyException(final Throwable cause) {
    super(cause);
  }
   ...
   * @since 1.4
   */
  public TaxGroupNotEmptyException(final String message, Throwable cause) {
    super(message, cause);
  }
}
