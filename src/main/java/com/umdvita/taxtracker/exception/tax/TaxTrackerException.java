...
public class TaxTrackerException extends RuntimeException {
   ...
   */
  public TaxTrackerException(final String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public TaxTrackerException(final Throwable cause) {
    super(cause);
  }
   ...
   * @since 1.4
   */
  public TaxTrackerException(final String message, Throwable cause) {
    super(message, cause);
  }
}
