...
public interface PasswordTokenService {
   ...
   */
  Optional<PasswordToken> savePasswordTokenWithUser(String token, String email);
   ...
   * @return created token assigned to the user
   */
  Optional<PasswordToken> savePasswordTokenWithUser(String token, String email, int period);
