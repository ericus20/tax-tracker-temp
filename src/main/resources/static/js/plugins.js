...
!function (l, o, e) {
    ...
    l.fn.scrollUp = function (o) {
        ...
        var s, t, c, i, n, a, d,
            p = l.fn.scrollUp.settings = l.extend({}, l.fn.scrollUp.defaults, r), f = !1;
...
!function () {
    ...
    e.prototype.add = function (t) {
        ...
        var t, e = this.element == this.element.window, i = e ? void 0 : this.adapter.offset(),
            o = {};
        this.handleScroll(), t = {
            horizontal: {
    ...
    $.fn.meanmenu = function (e) {
        ...
        return this.each(function () {
            var n = e.meanMenuTarget, t = e.meanMenuContainer, r = e.meanMenuClose,
                i = e.meanMenuCloseSize, s = e.meanMenuOpen, u = e.meanRevealPosition,
                m = e.meanRevealPositionDistance, l = e.meanRevealColour, o = e.meanScreenWidth,
                c = e.meanNavPush, v = ".meanmenu-reveal", h = e.meanShowChildren,
                d = e.meanExpandableChildren, y = e.meanExpand, j = e.meanContract,
                Q = e.meanRemoveAttrs, f = e.onePage, g = e.meanDisplay, p = e.removeElements,
                C = !1;
...
jQuery(document).ready(function (s) {
    ...
    function n(i) {
        ...
        i.each(function () {
            ...
            }, p); else if (i.hasClass("clip")) {
                var a = i.find(".cd-words-wrapper"), n = a.width() + 10;
                a.css("width", n)
            } else if (!i.hasClass("type")) {
                var d = i.find(".cd-words-wrapper b"), l = 0;
                d.each(function () {
                    var i = s(this).width();
                    i > l && (l = i)
    ...
    function t(s) {
        ...
        } else s.parents(".cd-headline").hasClass("clip") ? s.parents(".cd-words-wrapper").animate({width: "2px"}, v, function () {
            c(s, i), d(i)
    ...
    function d(s, i) {
        s.parents(".cd-headline").hasClass("type") ? (r(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({width: s.width() + 10}, v, function () {
            setTimeout(function () {
                t(s)
            }, T)
        })
    ...
    var h = 2500, u = 3800, p = u - 3e3, f = 50, C = 150, m = 500, w = m + 800, v = 600, T = 1500;
    e()
});
...
!function (o) {
    o.fn.YouTubePopUp = function (e) {
        ...
        o(this).on("click", function (e) {
            ...
            if (a.match(/(youtu.be)/) || a.match(/(vimeo.com\/)+[0-9]/)) var p = "/", t = 3;
            if (a.match(/(vimeo.com\/)+[a-zA-Z]/)) var p = "/", t = 5;
            var i = a.split(p)[t], c = i.replace(/(&)+(.*)/, "");
...
!function (e, t) {
    ...
    function n() {
        var e, n, r, a = navigator.userAgent, s = navigator.appName,
            o = "" + parseFloat(navigator.appVersion), i = parseInt(navigator.appVersion, 10),
            l = !1, u = !1, c = !1, d = !1;
    ...
    function v(e, t, n, r, a) {
        var s = t.split(" ");
        if (L["boolean"](a) || (a = !1), e instanceof NodeList) for (var o = 0; o < e.length; o++) e[o] instanceof Node && v(e[o], arguments[1], arguments[2], arguments[3]); else for (var i = 0; i < s.length; i++) e[r ? "addEventListener" : "removeEventListener"](s[i], n, a)
    }
    ...
    function _() {
        ...
        if (L.undefined(t.cancelFullScreen)) for (var r = 0, a = n.length; a > r; r++) {
    ...
    function C(v, C) {
                        ...
                        l.onreadystatechange = function () {
                            if (4 === l.readyState) if (200 === l.status) {
                                ...
                                for (var a = 0; a < t.length; a++) {
                                    e = t[a], $e.captions[a] = [];
                                    var s = e.split(r), o = 0;
                                    -1 === s[o].indexOf(":") && (o = 1), $e.captions[a] = [s[o], s[o + 1]]
                                }
        ...
        function W(e) {
            ...
            if (!$e.usingTextTracks && "video" === $e.type && $e.supported.full && ($e.subcount = 0, e = L.number(e) ? e : $e.media.currentTime, $e.captions[$e.subcount])) {
                for (; r($e.captions[$e.subcount][0]) < e.toFixed(1);) if ($e.subcount++, $e.subcount > $e.captions.length - 1) {
        ...
        function J() {
            ...
            var t = B("input:not([disabled]), button:not([disabled])"), n = t[0],
                r = t[t.length - 1];
            g($e.container, "keydown", e)
        }

        function z(e, t) {
            if (L.string(t)) d(e, $e.media, {src: t}); else if (t.constructor === Array) for (var n = t.length - 1; n >= 0; n--) d(e, $e.media, t[n])
        }
        ...
        function G() {
            ...
            var r;
            if (L.string(C.selectors.controls.container) && (r = t.querySelector(C.selectors.controls.container)), L.htmlElement(r) || (r = $e.container), r.insertAdjacentHTML("beforeend", n), C.tooltips.controls) for (var a = B([C.selectors.controls.wrapper, " ", C.selectors.labels, " .", C.classes.hidden].join("")), s = a.length - 1; s >= 0; s--) {
                var i = a[s];
        ...
        function ee(e) {
            var t = C.i18n.play;
            if (L.string(C.title) && C.title.length && (t += ", " + C.title, $e.container.setAttribute("aria-label", C.title)), $e.supported.full && $e.buttons.play) for (var n = $e.buttons.play.length - 1; n >= 0; n--) $e.buttons.play[n].setAttribute("aria-label", t);
            L.htmlElement(e) && e.setAttribute("title", C.i18n.frameTitle.replace("{title}", C.title))
        }

        function te() {
            var t = null;
            $e.storage = {}, j.supported && C.storage.enabled && (e.localStorage.removeItem("plyr-volume"), t = e.localStorage.getItem(C.storage.key), t && (/^\d+(\.\d+)?$/.test(t) ? ne({volume: parseFloat(t)}) : $e.storage = JSON.parse(t)))
        }
        ...
        function ae() {
            var n, r = t.createElement("div"), s = $e.type + "-" + Math.floor(1e4 * Math.random());
            switch ($e.type) {
                case"youtube":
                    n = S($e.embedId);
                    break;
            ...
            }); else if ("vimeo" === $e.type) if ($e.supported.full ? $e.media.appendChild(r) : r = $e.media, r.setAttribute("id", s), L.object(e.Vimeo)) ie(n, r); else {
                a(C.urls.vimeo.api);
        ...
        function oe(t, n) {
            $e.embed = new e.YT.Player(n.id, {
                ...
                events: {
                    onError: function (e) {
                        I($e.container, "error", !0, {code: e.data, embed: e.target})
                    }, onReady: function (t) {
                        var n = t.target;
                        ...
                        I($e.container, "statechange", !1, {code: t.data})
                    }
                }
            })
        }
        ...
        function ie(n, r) {
            ...
            var s = {
                    ...
                    speed: !0,
                    transparent: 0
                }, o = a(s), i = t.createElement("iframe"),
        ...
        function Se() {
            ...
            $e.supported.full && ($e.volume.input && ($e.volume.input.value = e), $e.volume.display && ($e.volume.display.value = e)), ne({volume: e}), m($e.container, C.classes.muted, 0 === e), $e.supported.full && $e.buttons.mute && w($e.buttons.mute, 0 === e)
        }

        function Ee(e) {
            $e.supported.full && $e.buttons.captions && (L["boolean"](e) || (e = -1 === $e.container.className.indexOf(C.classes.captions.active)), $e.captionsEnabled = e, w($e.buttons.captions, $e.captionsEnabled), m($e.container, C.classes.captions.active, $e.captionsEnabled), I($e.container, $e.captionsEnabled ? "captionsenabled" : "captionsdisabled", !0), ne({captionsEnabled: $e.captionsEnabled}))
        }
        ...
        function Ce(e) {
            if ($e.supported.full) {
                var t = $e.progress.played, n = 0, r = ye();
                if (e) switch (e.type) {
                    case"timeupdate":
                    case"seeking":
        ...
        function Me(e) {
            ...
            if (C.tooltips.seek && $e.progress.container && 0 !== t) {
                var n = $e.progress.container.getBoundingClientRect(), r = 0,
        ...
        function Oe(t) {
            if (C.hideControls && "audio" !== $e.type) {
                var n = 0, r = !1, a = t, o = f($e.container, C.classes.loading);
        ...
        function qe() {
            function n() {
                var e = de(), t = $e.buttons[e ? "play" : "pause"],
            ...
            function o(e) {
                for (var t in $e.buttons) {
                    var n = $e.buttons[t];
                    if (L.nodeList(n)) for (var r = 0; r < n.length; r++) m(n[r], C.classes.tabFocus, n[r] === e); else m(n, C.classes.tabFocus, n === e)
                }
            }
        ...
        var Xe, $e = this, Je = {};
        $e.media = v;
        var ze = v.cloneNode(!0), Ge = function () {
            R("log", arguments)
        }, Ke = function () {
            R("warn", arguments)
        };
    ...
    function A(e) {
        var r = n(), a = r.isIE && r.version <= 9, s = r.isIos, o = r.isIphone,
            i = !!t.createElement("audio").canPlayType, l = !!t.createElement("video").canPlayType,
            u = !1, c = !1;
        switch (e) {
            case"video":
                u = l, c = u && !a && !o;
    ...
    function I(e, n) {
        function r(e, t) {
            f(t, O.classes.hook) || a.push({target: e, media: t})
        }

        var a = [], s = [], o = [O.selectors.html5, O.selectors.embed].join(",");
        ...
        return a.forEach(function (e) {
            ...
            if (L.object(u)) {
                ...
                k(u.getContainer(), "setup", !0, {plyr: u}), s.push(u)
            }
        }), s
    }
    ...
    function N(e) {
        if (L.string(e) ? e = t.querySelector(e) : L.undefined(e) && (e = t.body), L.htmlElement(e)) {
            var n = e.querySelectorAll("." + O.classes.setup), r = [];
    ...
    return {setup: I, supported: A, loadSprite: F, get: N}
}), function () {
    function e(e, t) {
        ...
        return function () {
            ...
            return b.Extend(c, b.Observable), c.prototype.render = function () {
                ...
                this.$results.attr("id", f), c.on("results:all", function (a) {
                    ...
                    var a = e.getHighlightedResults(), b = e.$results.find("[aria-selected]"),
                        c = b.index(a);
                    if (!(c <= 0)) {
                        var d = c - 1;
                        0 === a.length && (d = 0);
                        ...
                        var g = e.$results.offset().top, h = f.offset().top,
            ...
            return c.Extend(e, b), e.prototype.render = function () {
                ...
                var b = a[0], c = this.$selection.find(".select2-selection__rendered"),
                    d = this.display(b, c);
...
(function () {
    ...
    e = function () {
        ...
        return e.prototype.hasNext = function () {
            ...
            var t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x, T, N, C, k, L,
                A, O, M, _, D;
            if (typeof e != "object") {
...
!function (i) {
    function s() {
        var s = i(window).width(), c = i(window).height(), d = i(".fl").outerWidth(),
            e = i(".fl").outerHeight();
